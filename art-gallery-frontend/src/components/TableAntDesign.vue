<template>
  <div class="main-div">
    ...
    <div class="add-exhibition-div" v-if="addExhibitionClicked">
      ...
      <input
        type="text"
        v-model="this.backgroundImageUrl"
        class="table-input"
        placeholder="Enter backgroundImageUrl..."
      />
...
export default {
      ...
      columns: [
        {
          ...
          customRender: (data) => {
            return <img src={data.text} style="max-height:200px; width:300px; object-fit:cover" />;
          },
        },
        {
          title: "Name",
  ...
  methods: {
    ...
    showInputs() {
      if (!this.addExhibitionClicked) this.addExhibitionClicked = true;
      else this.addExhibitionClicked = false;
    },
    ...
    async addExhibition() {
      ...
      if (this.account.user) {
        ...
        this.postResult = await postExhibition(
          this.name,
          this.description,
